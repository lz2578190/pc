...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就绪"),
        ("Established", "已建立"),
        ("connecting_status", "正在接入会议"),
        ("Enable service", "允许服务"),
        ("Start service", "启动会议"),
        ("Service is running", "会议正在运行"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将会议安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予会议 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予会议 \"开始接入\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("How to get Android input permission?", "温馨提示"),
        ("android_input_permission_tip1", "为了更好的服务，你需要允许会议使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [银联会议] 服务开启。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持会议后台服务"),
        ("Ignore Battery Optimizations", "加强会议连接稳定性 [建议开启] "),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的会议应用设置页面中，找到并进入电源页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自动优化"),
        ("Start the screen sharing service on boot, requires special permissions", "开机自动优化会议服务 [建议开启] 。"),
        ...
        ("Proxy", "代理"),
        ("Apply", "应用"),
        ("Disconnect all devices?", "断开所有会议连接？"),
        ("Clear", "清空"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予会议 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予会议 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行会议的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证会议密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你启动会议，请勿继续操作并立刻挂断电话。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，会议可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当会议窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持会议后台服务"),
